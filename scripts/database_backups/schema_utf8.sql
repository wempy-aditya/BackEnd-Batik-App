--
-- PostgreSQL database dump - UTF-8 Compatible Clean Version with Superuser
--
...
--
-- Initial Data: Create Default Tier and Superuser
--

-- Insert default tier
INSERT INTO public.tier (id, name, created_at, updated_at)
VALUES (1, 'free', NOW(), NOW())
ON CONFLICT DO NOTHING;

-- Insert superuser (password will be hashed version of 'wempyaw0911')
-- Hash generated using: from passlib.context import CryptContext; CryptContext(schemes=["bcrypt"], deprecated="auto").hash("wempyaw0911")
...
VALUES (
    gen_random_uuid(),
    'aditya wempy',
    'adityawempy@webmail.umm.ac.id',
    '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5agyWY.DkBfBG',  -- hashed password for 'wempyaw0911'
    'admin',
    true,
    false,
    NOW(),
