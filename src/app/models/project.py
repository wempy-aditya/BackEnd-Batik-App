...
from .enums import AccessLevel, ContentStatus, ProjectComplexity
...
class Project(Base):
    ...
    # Project metadata
    complexity: Mapped[ProjectComplexity | None] = mapped_column(Enum(ProjectComplexity), default=None)
